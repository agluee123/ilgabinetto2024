  ...
  <div id="carouselExampleCaptions" class="carousel slide">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" style="max-height: 900px; object-fit: cover;">
        <img src="/ilgabinetto/imagenes/16.jpg" class="d-block img-fluid width:100%" alt="...">
      ...
      <div class="carousel-item" style="max-height: 900px ; object-fit:cover">
        <img src="/ilgabinetto/imagenes/17.jpg" class="d-block img-fluid width:100%" alt="..." />
        <div class="carousel-caption d-none d-md-block bg-dark-transparent">
      ...
      <div class="carousel-item" style="max-height: 900px ; object-fit:cover">
        <img src="/ilgabinetto/imagenes/30-min.jpg" class="d-block img-fluid width:100%" alt="..." />
        <div class="carousel-caption d-none d-md-block bg-dark-transparent">
